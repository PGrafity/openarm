...
1. Attach `J4_A` to the `J3` motor using 6 `M3x6` bolts. Make sure the two Power+CAN ports face the front and rear for easy wiring, and that the communication port facees to the right.
...
3. Place the `J4_B` on the interior side of `J4_A`,aligning the holes. Make sure that each holes is in the correct position. Do not fasten them yet.
